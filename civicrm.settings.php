...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://neprofitneorg:pass@localhost/neprofitneorg?new_link=true');
  }
}
...
$civicrm_root = '/var/aegir/platforms/drupal-7.57/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/aegir/platforms/drupal-7.57/sites/neprofitne.org/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://neprofitne.org');
}
...
$civicrm_setting['Directory Preferences']['uploadDir'] = '/var/aegir/platforms/drupal-7.57/sites/neprofitne.org/files/civicrm/upload';
...
// define( 'CIVICRM_MAIL_LOG', '/var/aegir/platforms/drupal-7.57/sites/neprofitne.org/files/civicrm/templates_c/mail.log');
// }
